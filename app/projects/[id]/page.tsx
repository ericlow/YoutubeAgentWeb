      ...
      <header className="md:hidden border-b bg-card sticky top-0 z-40">
        <div className="px-4 py-3">
          <div className="flex items-center gap-1.5 text-xs text-muted-foreground mb-2">
            ...
            <span className="text-foreground font-medium truncate">{mockProject.name}</span>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 flex-1 min-w-0">
              ...
              <h1 className="text-base font-bold truncate">{mockProject.name}</h1>
            </div>
            <div className="flex items-center gap-2">
              ...
              <Button
                size="icon"
                className="h-9 w-9 bg-[#007AFF] hover:bg-[#0051D5] text-white"
                onClick={() => setIsAddVideoOpen(true)}
              >
          ...
          {filteredVideos.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {filteredVideos.map((video) => (
                <Card
                  key={video.id}
                  className="overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer group border-2 hover:border-blue-300 dark:hover:border-blue-700 bg-blue-50 dark:bg-blue-950/20 hover:scale-105 transform active:scale-100"
                ...
                >
                  ...
                  {/* Content */}
                  <div className="p-4">
                    <h3 className="font-semibold text-sm mb-2 line-clamp-2 text-balance leading-snug">{video.title}</h3>
